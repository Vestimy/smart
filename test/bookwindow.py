...
from PySide6.QtSql import QSqlRelation, QSqlRelationalTableModel, QSqlTableModel,QSqlRelationalDelegate
...
class BookWindow(QMainWindow, Ui_BookWindow):
    ...
    def __init__(self):
        ...
        self.bookTable.setItemDelegate(QSqlRelationalDelegate(self.bookTable))
    ...
    def showError(err):
        QMessageBox.critical(err, "Unable to initialize Database",
